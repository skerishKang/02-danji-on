...
document.addEventListener('click',function(ev){
 ...
 if(cls.contains('brand')){ev.preventDefault();ev.stopImmediatePropagation();go('index3.html');return;}
...
(function(){
  ...
  function reportRoute(){
    try{
      const file=decodeURIComponent((location.pathname.split('/').pop()||'index3.html').split('?')[0]);
