...
assert.match(api, /requireVerifiedResident\(/, 'review read/create must use verified-resident AuthZ');
...
console.log('PASS business review/reply persistence AuthZ and privacy contract');
