...
- 상시 운영 규칙: `docs/tracks/OWNER_CENTRAL_AGENT_OPERATING_POLICY_20260914.md`
- 사용자(Owner)는 기본 터미널/CI/배포 운영자가 아니다.
- 반복 운영은 CENTRAL 직접 수행을 우선하고, 불가능하면 승인된 로컬/KILO 에이전트에 위임한다.
- 사용자 수동 조작은 자동화/위임이 불가능한 불가피한 단계에만 요청한다.
