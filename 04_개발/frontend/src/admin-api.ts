...
class MockAdminAdapter {
  ...
  async createPost(input: { sourceName: string; category: string; title: string; body: string; channel?: string; displayMode?: 'highlight' | 'article'; attachmentObjectKey?: string | null }) {
