...
}
{
  ...
  assert.match(wiring, /12_이웃대화_첫화면\.html\?type=hello'\+\(apiBase\?'\&apiBase='\+encodeURIComponent\(apiBase\):''\)/, 'page 14 returns to the community surface with conditional session base (#863)');
