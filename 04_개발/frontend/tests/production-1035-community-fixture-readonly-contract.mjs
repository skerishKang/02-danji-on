...
assert.ok(script.includes('ownedByTestResident'));
assert.ok(script.includes('AUDIT_UI_COMMENT'));
assert.ok(script.includes('AUDIT_COMMENT_HANDLER'));
assert.ok(script.includes('AUDIT_REPLY_HANDLER'));
