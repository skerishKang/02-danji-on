...
}
{
  ...
  assert.match(w20, /withApiBase\('21_메시지_대화상세\.html\?conversation='/, '21 navigation carries a conditional apiBase + conversation');
  assert.match(w20, /21_메시지_대화상세\.html\?conversation='/);
